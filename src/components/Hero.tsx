        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 animate-fade-in-left">
            <div className={`inline-flex items-center backdrop-blur-sm border rounded-full px-4 py-1.5 mb-6 ${
              ...
              <span className={`text-xs mr-1 ${theme === 'dark' ? 'text-gray-300' : 'text-slate-700'}`}>AI-Powered Trading Signals</span>
              <ChevronRight className={`h-4 w-4 ${theme === 'dark' ? 'text-gray-400' : 'text-slate-500'}`} />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              <span className={`font-bold ${theme === 'dark' ? 'text-gradient' : 'text-crypto-purple'}`}>Trade Crypto</span>
              <span className={`font-bold ${theme === 'dark' ? 'text-white' : 'text-slate-600'}`}> with Confidence & Clarity</span>
            </h1>
            ...
            <div className="mt-8 flex items-center space-x-6">
              <div>
                <p className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>$2.5B+</p>
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-slate-600'}`}>Trading Volume</p>
              </div>
              <div className={`h-12 w-px ${theme === 'dark' ? 'bg-gray-700' : 'bg-slate-400'}`}></div>
              <div>
                <p className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>120K+</p>
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-slate-600'}`}>Active Traders</p>
              </div>
              <div className={`h-12 w-px ${theme === 'dark' ? 'bg-gray-700' : 'bg-slate-400'}`}></div>
              <div>
                <p className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}>50+</p>
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-slate-600'}`}>Global Markets</p>
              </div>
            </div>
          </div>
